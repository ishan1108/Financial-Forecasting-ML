...
def Analysis(random_forest):
    ...
    classifier_name = random_forest[1]
...
rf= RandomForestClassifier(n_estimators = 1001, max_depth=50,bootstrap=True, oob_score=False,
                           max_leaf_nodes=None, min_impurity_decrease=0.0, min_impurity_split=None)


# Saving the randomforest model for future predictions
...
for random_forest in infos:
     accuracy, precision, recall, f1 = Analysis(random_forest)
...
plt.savefig('randomforest_barChart.pdf')